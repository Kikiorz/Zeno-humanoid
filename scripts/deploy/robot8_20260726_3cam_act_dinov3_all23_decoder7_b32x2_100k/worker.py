#!/usr/bin/env python3
"""Inference entry point for the Robot8 2026-07-26 raw-label ACT baseline."""
...
DEFAULT_CHECKPOINT_ROOT = (
    ...
    / "outputs"
    / "train"
    / "robot8_20260726_act_dinov3_3cam_640x480_nocrop_all23_decoder7_b32x2_100k"
)
...
def main() -> None:
    # The shared worker resolves the highest complete checkpoint below this
    # run directory (currently 100000), or accepts a fixed checkpoint path.
    ...
    if not has_option("--center-crop-fraction"):
        # Training used direct 640x480 resize with no crop.
