#!/usr/bin/env bash
# Consumer-only normal-label training on GPU 0. It reads the durable shared
# DINO cache; it must never start a second backbone/cache process.
set -euo pipefail
...
RUN_ID="${RUN_ID:-robot8_20260729_act_dinov3_3cam_640x480_topcam_left_cam20260729_all23_decoder7_b32_100k}"
