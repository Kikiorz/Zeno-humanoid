...
NORMAL_SUCCESS="${NORMAL_SUCCESS:-${REPO_ROOT}/outputs/train/robot8_20260729_tearoom_act_dinov3_3cam_640x480_topcam_left_cam20260729_all23_decoder7_ddp64_b32_w6_60k/TRAINING_SUCCEEDED}"
