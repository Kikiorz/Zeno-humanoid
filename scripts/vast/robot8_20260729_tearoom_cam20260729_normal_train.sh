...
# effective global batch is therefore 64. The requested normal-label pass runs
...
RUN_ID="${RUN_ID:-robot8_20260729_tearoom_act_dinov3_3cam_640x480_topcam_left_cam20260729_all23_decoder7_ddp64_b32_60k}"
